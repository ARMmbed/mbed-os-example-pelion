...
------------------------------------| ------------------| ------------------------| --------------
Cypress `CYTFM_064B0S2_4343W`       | Wi-Fi             | Internal flash for credentials + external flash for FW candidate | To use `mbed-os-example-pelion` with the `CYTFM_064B0S2_4343W` board, please check out the `cytfm-064b0s2-4343w` branch and see the [*Running PDMC example on the CYTFM_064B0S2_4343W* document](../cytfm-064b0s2-4343w/TARGET_CYTFM_064B0S2_4343W/README.md).
